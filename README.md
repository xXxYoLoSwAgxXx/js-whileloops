...
3. From your terminal, navigate into the js-whileloops assignment:
    - `$ cd js-whileloops`
4. Open the js-whileloops assignment in sublime and write your code in the `exercises.js` file.
